...
import os
import time
from get_loss import sparse_categorical_crossentropy
...
checkpoint_callback=tf.keras.callbacks.ModelCheckpoint(filepath=checkpoint_prefix, monitor='val_accuracy', save_weights_only=True)
